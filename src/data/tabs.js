...
export const tabs = [
    ...
    { id: 'nutrition-plan', path: '/nutrition-plan', name: 'Plano Alimentar', icon: FileText, emoji: '🍽️', label: 'Plano Alimentar' },
    { id: 'food', path: '/food', name: 'Alimentação', icon: Camera, emoji: '🥗', label: 'Alimentação' },
